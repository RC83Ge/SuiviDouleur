...
import type { BodyZoneDef } from './FrontViewSVG';

export const BACK_ZONES: BodyZoneDef[] = [
  {
    id: 'head',
    label: 'Tête',
...
export function BackViewSVG({ selectedZones, hoveredZone, onZoneClick, onZoneHover }: BackViewSVGProps) {
  return (
    <>
      {BACK_ZONES.map(({ id, path }) => {
